...
export default function Merchant() {
  ...
  const handler = async (e) => {
    ...
    await fetch('http://localhost:3000/api/auth/data-driver', options)
        .then(res=>res.json())
        .then((datas)=>{
          console.log(datas);
          if(datas.status)router.push('http://localhost:3000/daftar/driver/data-kendaraan');
            ...
            <div class="position-absolute top-50 start-50 translate-middle">
                ...
                <div className={styles.setup_main}>
                    ...
                    <div className="buttons">
                        <Link href="/daftar/driver/data-kendaraan"><button className={styles.setup_next_btn} onClick={(e) => handler(e)}>Lanjutkan</button></Link>
                    </div>
                </div>
            </div>
        </div>
